...
class HostForm(Form):
    ...
    interface = TextField('dhcp_hosts.interface',[validators.Length(min=0,max=20)])
...
def print_hosts():
    ...
    try:
        ...
        query =  "select dhcp_hosts.last, dhcp_hosts.mac, dhcp_hosts.name, dhcp_hosts.ip, dhcp_hosts.interface, "
